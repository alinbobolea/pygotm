"""Output-variable definitions consumed by the schema builders.

Pure declarative data: the OutputVariable record, its factory helpers, and
the core/extra variable tuples. schema.py imports these back.
"""
